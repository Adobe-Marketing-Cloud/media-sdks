...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/Adobe-Marketing-Cloud/media-sdks/releases/tag/ios-v2.2.3"
  ...
  s.source       = { :git => 'https://github.com/Adobe-Marketing-Cloud/media-sdks.git', :tag => "ios-v2.2.3-cocoapod" }
