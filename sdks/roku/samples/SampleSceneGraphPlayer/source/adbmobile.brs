  ...
  if GetGlobalAA()._adb_deviceInfo = invalid
    instance = {
        _init: Function() as Void
            ...
            subTitle = appInfo.GetValue("subtitle")
    ...
    instance = {
      ...
      processMessage: Function() As Void
              ...
              if type(msg) = "roUrlEvent" AND msg.GetSourceIdentity() = m._http.GetIdentity()
                ...
                if responseCode = 200
                  _adb_logger().debug("Analytics - Successfully sent hit to url=(" + m._urlStub() +") with body=(" + m._currentHit.frag + ")")
...
Function _adb_audienceManager() As Object
  if GetGlobalAA()._audienceManager = invalid
      instance = {
        ...
        _setVisitorProfile: Function(_segments as Object) As Void
          End Function,
...
Function _adb_media() As Object
  if GetGlobalAA()._adb_media_instance = invalid
      instance = {
        ...
        End Function,
        _isError: Function(_reContext as Object) As Boolean
          return _adb_media_isInErrorState()
        End Function,

        _isMediaDisabled: Function(_reContext = invalid as Object) As Boolean
          return NOT(m._isEnabled)
        End Function,

        _isTracking: Function(_reContext as Object) As Boolean
          return _adb_mediacontext().isActiveTracking()
        End Function,

        _isInMedia: Function(_reContext as Object) As Boolean
          return _adb_mediacontext().isActiveSession()
        End Function,

        _isInAd: Function(_reContext as Object) As Boolean
          return _adb_mediacontext().isInAd()
        End Function,

        _isInAdBreak: Function(_reContext as Object) As Boolean
          return _adb_mediacontext().isInAdBreak()
        End Function,

        _isInChapter: Function(_reContext as Object) As Boolean
          return _adb_mediacontext().isInChapter()
        End Function,

        _isInBuffer: Function(_reContext as Object) As Boolean
          return _adb_mediacontext().isBuffering()
        End Function,

        _isInSeek: Function(_reContext as Object) As Boolean
        ...
        _doAllowPlayerStateChange: Function(_reContext as Object) As Boolean
        ...
        _cmdConfigure: Function(_reContext as Object) As Void
        ...
        _cmdSessionEnd: Function(_reContext as Object) As Void
        ...
        _cmdAdBreakComplete: Function(_reContext as Object) As Void
        ...
        _cmdAdComplete: Function(_reContext as Object) As Void
        ...
        _cmdAdSkip: Function(_reContext as Object) As Void
        ...
        _cmdChapterComplete: Function(_reContext as Object) As Void
        ...
        _cmdChapterSkip: Function(_reContext as Object) As Void
        ...
        _cmdPlay: Function(_reContext as Object) As Void
          _adb_mediacontext().setInPaused(false)
          _adb_mediacontext().resetAssetRefContext()
          m._playUnhandledFromPrerollWaitTime = false
        End Function,

        _cmdPause: Function(_reContext as Object) As Void
          _adb_mediacontext().setInPaused(true)
          _adb_mediacontext().resetAssetRefContext()
        End Function,

        _cmdSeekStart: Function(_reContext as Object) As Void
          _adb_mediacontext().setInSeeking(true)
          _adb_mediacontext().resetAssetRefContext()
        End Function,

        _cmdSeekComplete: Function(_reContext as Object) As Void
        ...
        _cmdBufferStart: Function(_reContext as Object) As Void
          _adb_mediacontext().setInBuffering(true)
          _adb_mediacontext().resetAssetRefContext()
        End Function,

        _cmdBufferComplete: Function(_reContext as Object) As Void
        ...
        _cmdStartPlayheadTimer: Function(_reContext as Object) As Void
          m._logger.debug("#::_cmdStartPlayheadTimer()")
          _adb_clockservice().startTimer(_adb_clockservice().id_playhead_timer)
        End Function,

        _cmdStopPlayheadTimer: Function(_reContext as Object) As Void
        ...
        _cmdBitrate: Function(_reContext as Object) As Void
        ...
        _cmdTrackPlaybackState: Function(_reContext as Object) As Void
        ...
        _cmdDisableMedia: Function(_reContext as Object) As Void
          m._logger.debug("#_cmdDisableMedia: Media tracking disabled remotely.")
          m._isEnabled = false
        End Function,

        _cmdDetectVideoIdle: Function(_reContext as Object) As Void
          if m._isTrackingSuspended
...
Function _adb_message(messageJson As Object) As Object
  instance = {
    ...
    checkValidShowRule: Function(ruleName As String) As Boolean
      if ruleName = m.MESSAGE_SHOW_RULE_STRING_ALWAYS OR ruleName = m.MESSAGE_SHOW_RULE_STRING_ONCE
        return true
      endif
    ...
    buildExpansionsForTokens: Function(tokens As Object, urlEncodeExpansions As Boolean) As Object
      ...
      for each key in combinedVars.keys()
        ...
        if type(keyStr) = "roString" OR type(keyStr) = "String"
          _val = combinedVars[keyStr]
        endif
      end for

      _combinedVarKeys = combinedVars.keys()
...
Function _adb_message_matcher_unknown() As Object
  instance = {
    ...
    matches: Function(_expectedValue As Object) As Boolean
      return false
    End Function
  }
...
Function _adb_message_template_callback() As Object
    instance = {
        ...
        setPayloadObject: Function(_messageJson as Object) As Void
        End Function,

        shouldShowForVariables: Function(_vars As Object, _cData As Object) As Boolean
        End Function,

        putMapForTemplatedTokens: Function(_combinedVars)
        End Function
      }
    ...
    instance = {
      ...
      _sendNextHit: Function() as Void
        if m._queue.count() > 0 AND m._currentHit = invalid
          ...
          body = m._currentHit.body
          if body <> invalid AND body <> ""
            m._http.SetRequest("POST")
            m._http.AsyncPostFromString(body.toStr())
          else
            m._http.SetRequest("GET")
