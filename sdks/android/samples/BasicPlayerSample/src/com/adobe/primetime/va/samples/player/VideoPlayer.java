...
public class VideoPlayer extends Observable {
    private static final String LOG_TAG = "[MediaSDKSample]::" + VideoPlayer.class.getSimpleName();
    ...
    public VideoPlayer(Activity parentActivity) {
        ...
        _streamType = MediaHeartbeat.StreamType.VOD;
    ...
    private void _startAd() {
        ...
        _adBreakInfo.put("playerName", _playerName);
